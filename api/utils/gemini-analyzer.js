...
重要:
- **テキスト除外が最優先**: すべてのプロンプトに「absolutely no text」「completely text-free」を必ず含めてください
- **Geminiはテキスト生成が非常に苦手**: 特に日本語テキストは必ず崩れるため、一切のテキストを生成してはいけません
- **DX SMEのような略語も禁止**: いかなる文字・記号も生成しないでください
